	...
	<div class="row">
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3 class="total_purchase" style="font-size: 25px;"></h3>
              <p>{{ __('home.total_purchase') }}</p>
            </div>
            <div class="icon">
              <i class="ion ion-cash"></i>
            </div>
            <a href="{{action('PurchaseController@index')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
      </div>
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3 class="total_sell" style="font-size: 25px;"></h3>
              <p>{{ __('home.total_sell') }}</p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-cart-outline"></i>
            </div>
            <a href="{{action('SellController@index')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
      </div>
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3 class="purchase_due" style="font-size: 25px;"></h3>
              <p>{{ __('home.purchase_due') }}</p>
            </div>
            <div class="icon">
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3 class="invoice_due" style="font-size: 25px;"></h3>
              <p>{{ __('home.invoice_due') }}</p>
            </div>
            <div class="icon">
